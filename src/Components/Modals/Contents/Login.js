            ...
            <div name="submitForm" id="modal_contents_login" className="" onSubmit={onSubmit}>
                <form name="modal_contents_form" className="">
                    ...
                    <div id="checkbox_div" className="mt-2 ml-2">
                        <label className="mr-4"><input id="store_id" name="storeID" type="checkbox" className="" onClick={storeIdClicked} checked={isIdChecked}/> 아이디 저장</label>
                        <label><input id="store_account_info" name="storeInfo" type="checkbox" className="" onClick={storeInfoClicked} checked={isInfoChecked}/> 로그인 정보 저장</label>
                    </div>
